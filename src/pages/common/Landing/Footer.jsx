            ...
            <div>
              ...
              <div className="flex">
                <input 
                  ...
                  className="bg-background text-foreground px-4 py-2 rounded-l-md focus:outline-none focus:ring-1 focus:ring-primary grow border border-input"
                />
